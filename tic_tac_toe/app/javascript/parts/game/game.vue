  ...
  <div class="row" v-if="game">
    <div class="col col-12 pb-2">
      <div class="d-flex justify-content-around">
        ...
        <div class="alert" :class="{'alert-success': game.winner.id == currentPlayer.id, 'alert-danger': game.winner.id != currentPlayer.id}" v-if="game.winner && isPlayingThisGame()">{{ game.winner.id == currentPlayer.id ? 'You Win' : 'You Lose' }}</div>
