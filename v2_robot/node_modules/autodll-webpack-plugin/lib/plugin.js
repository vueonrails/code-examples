      ...
      if (inject) {
        ...
        compiler.plugin('compilation', function (compilation) {
          compilation.plugin('html-webpack-plugin-before-html-generation', function (htmlPluginData, callback) {
            htmlPluginData.assets.js = (0, _index.concat)(getDllEntriesPaths('.js'), htmlPluginData.assets.js);
            htmlPluginData.assets.css = (0, _index.concat)(getDllEntriesPaths('.css'), htmlPluginData.assets.css);
